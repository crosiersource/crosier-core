...
VALUES ('71d1456b-3a9f-4589-8f71-42bbf6c91a3e', 'crosier-core (Menu Admin)', '', 'PAI',
...
VALUES ('e290e24f-a050-4bba-8ee8-877d55242267', 'Configurações', 'fas fa-cogs', 'DROPDOWN',
        ...
        '71d1456b-3a9f-4589-8f71-42bbf6c91a3e', 999, NULL, now(), now(), 1, 1, 1, null, '');


-- Parâmetros
DELETE
FROM cfg_entmenu
WHERE uuid = '849ef7e7-6dcb-4db6-b7e2-43b695ac6e90';

INSERT INTO `cfg_entmenu` (`uuid`, `label`, `icon`, `tipo`, `app_uuid`, `pai_uuid`, `ordem`, `css_style`, `inserted`,
                           `updated`, `estabelecimento_id`, `user_inserted_id`, `user_updated_id`, `url`, `roles`)
VALUES ('849ef7e7-6dcb-4db6-b7e2-43b695ac6e90', 'Parâmetros do Sistema', 'fas fa-columns', 'ENT',
        '175bd6d3-6c29-438a-9520-47fcee653cc5', 'e290e24f-a050-4bba-8ee8-877d55242267', 2, NULL, now(), now(), 1, 1, 1, '/cfg/config/list/', 'ROLE_ADMIN');
...
VALUES ('55b8894c-06b1-4d5e-8480-ad2a0150bfa6', 'Usuários', 'fas fa-users', 'ENT',
        '175bd6d3-6c29-438a-9520-47fcee653cc5', 'e290e24f-a050-4bba-8ee8-877d55242267', 4, NULL, now(), now(), 1, 1, 1, '/sec/user/list/', 'ROLE_ADMIN');
...
VALUES ('0fbcfb61-3224-4b72-a3e6-86785b21d379', 'Grupos de Usuários', 'fas fa-people-carry', 'ENT',
        '175bd6d3-6c29-438a-9520-47fcee653cc5', 'e290e24f-a050-4bba-8ee8-877d55242267', 5, NULL, now(), now(), 1, 1, 1, '/sec/group/list/', 'ROLE_ADMIN');
...
VALUES ('b87ebd2d-1af3-4aa9-b5e1-9d68ede111cc', 'Programas', 'fas fa-microchip', 'ENT',
        '175bd6d3-6c29-438a-9520-47fcee653cc5', 'e290e24f-a050-4bba-8ee8-877d55242267', 5, NULL, now(), now(), 1, 1, 1, '/cfg/program/list/', 'ROLE_ADMIN');
...
VALUES ('ceda07f6-a9fe-4bf8-a2cc-7bda0533d771', 'Aplicativos', 'fas fa-object-group', 'ENT',
        '175bd6d3-6c29-438a-9520-47fcee653cc5', 'e290e24f-a050-4bba-8ee8-877d55242267', 6, NULL, now(), now(), 1, 1, 1, '/cfg/app/list/', 'ROLE_ADMIN');
