...
VALUES ('849ef7e7-6dcb-4db6-b7e2-43b695ac6e90', 'Parâmetros do Sistema', 'fas fa-columns', 'ENT',
        '175bd6d3-6c29-438a-9520-47fcee653cc5', 'e290e24f-a050-4bba-8ee8-877d55242267', 2, NULL, now(), now(), 1, 1, 1);
...
DELETE
FROM cfg_entmenu
WHERE uuid = '886797b4-2124-43eb-b780-e271f7dc5c3b';
INSERT INTO `cfg_entmenu` (`uuid`, `label`, `icon`, `tipo`, `app_uuid`, `pai_uuid`, `ordem`, `css_style`, `inserted`,
                           `updated`, `estabelecimento_id`, `user_inserted_id`, `user_updated_id`)
VALUES ('886797b4-2124-43eb-b780-e271f7dc5c3b', 'Categorias de Pessoas', 'far fa-id-badge', 'ENT',
        '175bd6d3-6c29-438a-9520-47fcee653cc5',
        'e290e24f-a050-4bba-8ee8-877d55242267', 3, NULL, now(), now(), 1, 1, 1);
